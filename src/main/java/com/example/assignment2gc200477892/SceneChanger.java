...
public class SceneChanger {
    public static void changeScenes(ActionEvent event, String fxmlFile, String drinkId, String name, String category, String alcohol, String ingredient, String instruction, String photo) throws IOException {
